# Salt Extension for Apache Zookeeper
...
The saltext-zookeeper project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:salt-extensions/saltext-zookeeper.git
...
* Writing blog posts
* Sharing your experiences using Salt + Apache Zookeeper
  on social media
...
[docs]: https://salt-extensions.github.io/saltext-zookeeper/
