# Salt Extension for Zookeeper

Salt Extension for interacting with Zookeeper
...
The saltext-zookeeper project team welcomes contributions from the community.
...
```bash
# Clone the repo
git clone --origin salt git@github.com:salt-extensions/saltext-zookeeper.git

# Change to the repo dir
cd saltext-zookeeper

# Create a new venv
python3 -m venv env --prompt saltext-zookeeper
...
* Writing blog posts
* Posting on social media about how you used Salt+Zookeeper to solve your
...
[issues]: https://github.com/salt-extensions/saltext-zookeeper/issues
[PRs]: https://github.com/salt-extensions/saltext-zookeeper/pulls
[discussions]: https://github.com/salt-extensions/saltext-zookeeper/discussions
